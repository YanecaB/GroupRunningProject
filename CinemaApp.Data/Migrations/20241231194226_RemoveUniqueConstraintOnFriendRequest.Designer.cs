...
namespace CinemaApp.Data.Migrations
{
    ...
    [Migration("20241231194226_RemoveUniqueConstraintOnFriendRequest")]
    partial class RemoveUniqueConstraintOnFriendRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.FriendRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("SendRequestDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Membership", b =>
                {
                    b.Property<Guid>("ApplicationUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.ConfirmedRequestNotification", b =>
                {
                    b.HasBaseType("CinemaApp.Data.Models.Notification");

                    b.Property<Guid>("NewFriendId")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("NewFriendId");

                    b.HasDiscriminator().HasValue("ConfirmedRequestNotification");
                });
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.FriendRequest", b =>
                {
                    b.HasOne("CinemaApp.Data.Models.ApplicationUser", "Receiver")
                        .WithMany("ReceiveFriendRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CinemaApp.Data.Models.ApplicationUser", "Sender")
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.ConfirmedRequestNotification", b =>
                {
                    b.HasOne("CinemaApp.Data.Models.ApplicationUser", "NewFriend")
                        .WithMany()
                        .HasForeignKey("NewFriendId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("NewFriend");
                });
